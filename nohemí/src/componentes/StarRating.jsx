...
export default function StarRating({
    ...
    //estado temporal para manejar la claificacion al pasar le mouse
    ...
    function handleRating(rating) {
        setRating(rating);
        onSetRating?.apply(rating); //Lama a la funcion de callback si esta definida
    }
 ...
 * @param {Object} props  * @param {boolean} props.full - Indica si la estrella está rellena o vacía.  
 ...
 * @param {Function} props.onHoverOut - Función que se ejecuta al quitar el mouse de la estrella.  11   
